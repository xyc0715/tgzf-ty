...
class TGForwarder:
    def __init__(self, api_id, api_hash, string_session, channels_groups_monitor, forward_to_channel,
        ...
        self.urls_kw = ['magnet', 'cloud.189.cn']
...
if __name__ == '__main__':
    ...
    include = ['链接', '片名', '名称', '剧名', 'magnet', 'drive.uc.cn', 'caiyun.139.com', 'cloud.189.cn',
               'pan.quark.cn', '115cdn.com','115.com', 'anxia.com', 'alipan.com', 'aliyundrive.com', '夸克云盘', '阿里云盘', '磁力链接','123云盘']
    ...
    # 替换消息中关键字(tag/频道/群组)
    replacements = {
        forward_to_channel: ['SharePanBaidu','txtyzy','baicaoZY','djfxkk','tyysypzypd','Lsp115','yunpan189','QukanMovie','vip115hot','SharePanFilms','QuarkFree','ydyp888','bdwpzhpd','movielover8888_TV','BaiduCloudDisk','yp123pan','yunpansall','yunpanxunlei','yunpanqk','clouddriveresources','tianyirigeng','cloudtianyi','yggpan','ydypzyfx','yunpan139','tyypzhpd','douerpan','tgsearchers','leoziyuan','leopansou','yunpanuc','oneonefivewpfx','xx123pan','alyp_Animation','alyp_JLP',
                             "yunpanall","NewAliPan","ucquark", "uckuake", "yunpanshare", "yunpangroup", "Quark_0",
        ...
        "": ["🦜投稿", "电影", "电视剧", "🎉 投稿人", "• ", "🐝", "树洞频道", "云盘投稿", "广告合作", "✈️ 画境频道", "🌐 画境官网", "🎁 详情及下载", " - 影巢", "帮助咨询",
